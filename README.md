...
## Сущности и взаимодействие

```
User ──── делает заказ ────► Order ◄──── содержит ──── Pizza[]
                                │
                           обрабатывает
                                │
                           OrderService
...
| `Ready` | Готов — имя появляется на табло |
| `PickedUp` | Клиент забрал заказ |
...
https://trello.com/b/fi3JnTFB/pizza-time-%F0%9F%8D%95
